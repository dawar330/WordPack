  ...
  return (
    <div className="about section container">
      <div className="content has-text-centered">
        <h2 className="is-size-2">The WorkPack Digital Universe</h2>
      </div>
      <div className="description">
        <div className="content is-medium has-text-centered">
          <p>
            WorkPack is a community-driven ecosystem for Cardano Non-Fungible
            Tokens. Our goal is to make NFT trading accessible everywhere you
            can imagine. WorkPack Marketplace is your one-stop shop for Cardano
            ...
            write at
            <a href="mailto:contact@WorkPack.io">
              <i className="icon fas fa-envelope"></i>contact@WorkPack.io
            </a>
            , on
            <a
              ...
              rel="noreferrer"
            >
              <i className="icon fab fa-twitter"></i>@WorkPack
            </a>
            , or join our
            <a
      ...
      <div className="timeline">
          ...
          <div className="timeline-body">
            ...
            <div className="content is-medium">
              <ul>
                ...
                <li>Build The WorkPack Backend APIs.</li>
          ...
          <div className="timeline-body">
            ...
            <div className="content is-medium">
              <ul>
                ...
                <li>Create & Launch a Stake Pool for WorkPack.</li>
                <li>
          ...
          <div className="timeline-body">
            ...
            <div className="content is-medium">
              <ul>
                ...
                <li>Release The WorkPack Backend APIs as a Service.</li>
        ...
        <div className="timeline-container warning">
          ...
          <div className="timeline-body">
            ...
            <div className="content is-medium">
              <ul>
                <li>WorkPack Integration with Unity Game Engine.</li>
