  ...
  return (
    <div className="section container">
      ...
      <div className="content">
        ...
        <ul>
          <li>
            <h4>Which blockchain does WorkPack support?</h4>
            <p>
              WorkPack is a Cardano-based NFT marketplace, therefore only
          ...
          <li>
            <h4>What crypto wallets can I use with WorkPack?</h4>
            <p>
              For now the only Cardano wallet supporting smart contract
              interactions is Nami, so in order to use WorkPack the user needs a
          ...
          <li>
            <h4>What currencies can I use on WorkPack?</h4>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              coins there. To use them on WorkPack send these funds to a Nami
              wallet.
            </p>
            <br />
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                <strong>WorkPack Fee</strong>: We charge a 1% fee of the sale
        ...
        <ul>
          <li>
            ...
            <ol>
              ...
              <li>
                Connect this wallet to WorkPack via the “Connect” button at the
              ...
              <li>
                ...
                Congrats, your NFT is now for sale on WorkPack
              </li>
            </ol>
            <br />
          </li>
          <li>
            ...
            <p>
              If you are an NFT Project wanting to launch on WorkPack please
              contact us on Twitter and/or Discord.
            </p>
            <br />
          </li>
          <li>
            <h4>How do royalties work on WorkPack?</h4>
            <p>
              Each project can submit a request to get the verified by WorkPack
        ...
        <ul>
          <li>
            ...
            <ol>
              ...
              <li>
                Connect your wallet to WorkPack via the button at the top right
                corner.
              </li>
              <li>
          ...
          <li>
            ...
            <p>
              ...
              transaction fees. 1% of this goes to WorkPack, x% goes to the NFT
              creator (x can be 0 if the project has not setup royalties on
              WorkPack), the rest goes to the seller.
            </p>
            <br />
          </li>
          <li>
            ...
            <p>
              ...
              it to see the transaction history of this NFT on WorkPack.
            </p>
          </li>
        </ul>
        <h2>User Safety</h2>
        <ul>
          ...
          <li>
            <h4>How can I report fraudulent content on WorkPack?</h4>
            <p>
          ...
          <li>
            <h4>Is explicit or sensitive content allowed on WorkPack?</h4>
            <p>
              We do not tolerate hate messages, bullying, racism, sexism,
              homophobia, etc… as well as explicit images or content. Please
              report this type of content to keep the WorkPack space enjoyable
              for everyone.
            </p>
            <br />
          </li>
